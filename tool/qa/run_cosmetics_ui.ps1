...
Invoke-Gate 'Cosmetic ownership, equip and responsive UI tests' {
...
Invoke-Gate 'Step 8 balance/content regression' {
...
Write-Host "`nCOSMETIC + RESPONSIVE UI RELEASE GATE: PASS" -ForegroundColor Green
