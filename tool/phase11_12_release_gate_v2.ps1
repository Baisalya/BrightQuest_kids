...
Write-Host "Phase 11+12 v2: verifying already-applied source state..."
...
Write-Host ""
Write-Host "Phase 11+12 v2: formatting qualified files..."
dart format `
...
Write-Host ""
Write-Host "Phase 11+12 v2: flutter analyze..."
flutter analyze
...
Write-Host ""
Write-Host "Phase 11+12 v2: full flutter test..."
flutter test
if ($LASTEXITCODE -ne 0) { throw "Full flutter test failed." }

Write-Host ""
Write-Host "Phase 11+12 release gate v2 PASSED."
