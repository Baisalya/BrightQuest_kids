...
Write-Host "Phase 11+12: applying capability/accessibility hardening..."
dart run .\tool\apply_phase11_12_hardening.dart
if ($LASTEXITCODE -ne 0) { throw "Phase 11+12 source patcher failed." }

Write-Host ""
Write-Host "Phase 11+12: formatting changed files..."
dart format `
...
Write-Host ""
Write-Host "Phase 11+12: flutter analyze..."
flutter analyze
...
Write-Host ""
Write-Host "Phase 11+12: full flutter test..."
flutter test
if ($LASTEXITCODE -ne 0) { throw "Full flutter test failed." }

Write-Host ""
Write-Host "Phase 11+12 release gate PASSED."
