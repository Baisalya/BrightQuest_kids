              ...
              children: [
                ...
                BrightResponsive(
                  ...
                  builder: (context, _) => BrightSectionTitle(
                    title: 'Achievements',
                    subtitle:
                        'Badges you have earned by learning and exploring.',
                    icon: Icons.workspace_premium_rounded,
                    trailing: BrightPill(
                        icon: Icons.emoji_events_rounded,
                        label: '${earned.length}/${achievements.length}'),
                  ),
                ),
                BrightResponsive(
                  ...
                  builder: (context, _) => Column(
                    ...
                    children: [
                      const BrightSectionTitle(
                          title: 'Cosmetics owned',
                          subtitle:
                              'Safe rewards that change how your explorer space looks.',
                      ...
                      const InfoBanner(
                          ...
                          text:
                              'Class, child profiles and daily limits are managed in the locked Parents area.'),
                    ],
                  ),
                ),
              ],
...
class _ProfileHero extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: const [
            BoxShadow(
                color: Color(0x247351E9), blurRadius: 28, offset: Offset(0, 10))
          ],
        ),
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            final avatar = Container(
              ...
              decoration: BoxDecoration(
                  ...
                  border: Border.all(color: const Color(0xFFFFE48A), width: 5),
                  boxShadow: const [
                    BoxShadow(
              ...
              child: Text(controller.activeProfileAvatar,
            ...
            final details = Column(
              ...
              children: [
                ...
                Text(
                    'Class ${controller.selectedClass} • Explorer Level ${controller.level}',
                    style: TextStyle(
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    _ProfileStat(
                        ...
                        emoji: '🔥'),
                    _ProfileStat(
                        label: 'XP', value: '${controller.xp}', emoji: '⚡'),
                  ],
                ),
                const SizedBox(height: 12),
          ...
          decoration: BoxDecoration(
            gradient: unlocked
                ? const LinearGradient(
                    colors: [Color(0xFFFFFAE6), Color(0xFFFFFFFF)])
                : null,
            color: unlocked ? null : Colors.black.withValues(alpha: 0.035),
            borderRadius: BorderRadius.circular(20),
            border: Border.all(
                color: unlocked ? const Color(0xFFFFD36A) : Colors.black12,
                width: 1.3),
            boxShadow: unlocked
                ? const [
                    BoxShadow(
