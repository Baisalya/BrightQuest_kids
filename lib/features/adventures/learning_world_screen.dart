            ...
            SliverToBoxAdapter(
              child: BrightResponsive(
                ...
                builder: (context, _) => BrightSectionTitle(
                  ...
                  trailing: Text('$completed/${levels.length} cleared',
          ...
          builder: (context, constraints) {
            ...
            final scene = Container(
              ...
              decoration: BoxDecoration(
                  ...
                  border: Border.all(
                      color: Colors.white.withValues(alpha: .58), width: 2)),
              child: Stack(
                fit: StackFit.expand,
                children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  Wrap(spacing: 8, runSpacing: 8, children: [
                    _HeroChip(text: '$completed/$total levels'),
                    _HeroChip(text: '⭐ $stars/${total * 3}')
                  ]),
                ],
              ),
            );
...
class _RoadLevel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final stageEmoji = level.type == LearningLevelType.mastery
        ? '👑'
        : level.type == LearningLevelType.challenge
            ? '⚡'
            : '🌟';
    final node = Container(
      ...
      decoration: BoxDecoration(
        gradient: unlocked
            ? LinearGradient(colors: [palette.primary, palette.deep])
        ...
        boxShadow: [
          BoxShadow(
              color: (unlocked ? palette.primary : Colors.black12)
                  .withValues(alpha: 0.28),
              blurRadius: 18,
              offset: const Offset(0, 8))
        ],
      ),
      child: Text(unlocked ? stageEmoji : '🔒',
          style: TextStyle(fontSize: level.isMastery ? 30 : 25)),
    );
      ...
      child: BrightSurface(
        ...
        child: Column(
          ...
          children: [
            Wrap(
              ...
              children: [
                ...
                BrightPill(
                  ...
                  color:
                      level.isMastery ? const Color(0xFF8A6000) : palette.deep,
                  background: level.isMastery
            ...
            Text('${game.title} • Difficulty ${level.difficulty}',
                style: const TextStyle(
                    fontSize: 11,
                    color: AppTheme.inkMuted,
            ...
            Text(level.summary,
                ...
                style: const TextStyle(
                    color: AppTheme.inkMuted, height: 1.3, fontSize: 12)),
            const SizedBox(height: 9),
            Row(
              children: [
                Expanded(
    ...
    return BrightReveal(
      ...
      child: BrightPressableScale(
        ...
        child: Row(
          ...
          children: isRight
              ? [card, const SizedBox(width: 12), node]
              : [node, const SizedBox(width: 12), card],
        ),
      ),
    );
  }
