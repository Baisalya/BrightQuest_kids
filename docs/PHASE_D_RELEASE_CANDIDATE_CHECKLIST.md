...
A green automated Phase D is **QA evidence only**. The runner has no artifact
build switches; AAB/Windows generation is a separate action. Neither result by itself makes the ₹299 pack
